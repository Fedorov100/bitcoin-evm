...
var (
	...
	RPCGlobalTxFeeCapFlag = cli.Float64Flag{
		Name:  "rpc.txfeecap",
		Usage: "Sets a cap on transaction fee (in Unit) that can be sent via the RPC APIs (0 = no cap)",
		Value: gossip.DefaultConfig(cachescale.Identity).RPCTxFeeCap,
	}

	AllowedGalaxyGenesisHashes = map[uint64]hash.Hash{
		galaxy.MainNetworkID: hash.HexToHash("0x2060eb5eefb65a80ce38a1f63e890941ba220c01b29ca392666eeacf98180c5b"),
		galaxy.TestNetworkID: hash.HexToHash("0x8cde22e2224d48a5e4c737fdc6df5fb8d0b8b73ef5db9528b56ecdffc7a2d10a"),
	}
)
...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "eth", "btc", "dag", "sfc", "abft", "web3")
	cfg.WSModules = append(cfg.WSModules, "eth", "btc", "dag", "sfc", "abft", "web3")
